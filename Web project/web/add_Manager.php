...
if($_SERVER['REQUEST_METHOD']== "POST"){
   ...
   $query="INSERT INTO Managers
    (name,phone,email,password,status,address,description )
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  ...
                  <?php
                              ...
                              ?>
                    <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']?>" enctype="multipart/data-form">
                      <div class="form-body">
                        <h4 class="form-section"><i class="ft-user"></i>Add Manager</h4>
                        <div class="row">
                          <div class="col-md-6">
